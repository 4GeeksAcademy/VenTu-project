...
Revision ID: 9daa5e2342a8
Revises: 
Create Date: 2024-10-23 23:18:50.568920
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('CLIENT', 'PROVIDER', name='userrole'), nullable=False),
