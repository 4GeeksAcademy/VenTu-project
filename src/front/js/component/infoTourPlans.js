                ...
                <div className="row ">
                    ...
                    <div className="col-12 d-flex align-items-center"> 
                        <div className="col-10 d-flex align-items-center">
                            ...
                            <h2 className="text p-2 fw-bold"> {actividad.title}</h2>
                        </div>
                        ...
                        <div className="col-sm-3 mb-3 mb-sm-0">
                            <div className="card">
                                <div className="card-body">
                                    <h5 className="fw-bold">$100 {actividad.price} Por persona</h5>
    
                                    <div className="d-flex justify-content-between">
                                        <p className="fw-bold " >Inicio</p>
                                        <p className=" text"> 10-10-2024{actividad.start_date} </p>
                                    </div>

                                    <div className="d-flex justify-content-between">
                                        <p className="fw-bold">Culminación</p>
                                        <p className=" text"> 10-10-2024{actividad.end_date} </p>
                                    </div>

                                    <div className="d-flex justify-content-between mb-2">
                                        <p className="fw-bold ">Puestos Disponibles</p>
                                        <p className=" text"> 10 {actividad.available_spots} </p>
                                    </div>
