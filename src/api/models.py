...
class User(db.Model):
    ...
    role = db.Column(db.Enum(UserRole), nullable=False)  # "provider" or "client"
...
class TourPlan(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    provider = db.relationship('User', backref='tour_plan')
...
class Reservation(db.Model):
    ...
    # Relaciones
    client = db.relationship('User', backref='reservations')
